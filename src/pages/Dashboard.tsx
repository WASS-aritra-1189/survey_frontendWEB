  ...
  return (
    <AdminLayout title="Dashboard" subtitle="Overview of your survey system">
      <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mb-4 sm:mb-6">
        <Card variant="stat" className="p-3 sm:p-4 cursor-pointer hover:shadow-md hover:border-primary/40 transition-all duration-200" onClick={() => navigate('/users')}>
        ...
        <Card variant="stat" className="p-3 sm:p-4 cursor-pointer hover:shadow-md hover:border-primary/40 transition-all duration-200" onClick={() => navigate('/surveys')}>
          <div className="flex items-center gap-3 sm:gap-4">
        ...
        <Card variant="stat" className="p-3 sm:p-4 cursor-pointer hover:shadow-md hover:border-primary/40 transition-all duration-200" onClick={() => navigate('/responses')}>
          <div className="flex items-center gap-3 sm:gap-4">
        ...
        <Card variant="stat" className="p-3 sm:p-4 cursor-pointer hover:shadow-md hover:border-primary/40 transition-all duration-200" onClick={() => navigate('/surveys/stats')}>
          <div className="flex items-center gap-3 sm:gap-4">
